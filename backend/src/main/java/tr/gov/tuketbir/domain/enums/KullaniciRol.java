...
public enum KullaniciRol {
    SISTEM_ADMIN("Sistem Yöneticisi", new String[]{
        ...
        "PERM_BIRLIK_CREATE", "PERM_BIRLIK_READ", "PERM_BIRLIK_UPDATE", "PERM_BIRLIK_DELETE", "PERM_BIRLIK_MANAGE",
        ...
        "PERM_TOPLANTI_CREATE", "PERM_TOPLANTI_READ", "PERM_TOPLANTI_UPDATE", "PERM_TOPLANTI_DELETE",
        "PERM_RAPOR_AIDAT", "PERM_RAPOR_MALI", "PERM_RAPOR_UYE", "PERM_RAPOR_GENEL",
        "PERM_SISTEM_AYAR", "PERM_YEDEKLEME", "PERM_AUDIT_LOG", "PERM_AUDIT_READ",
    ...
    BIRLIK_YONETICI("Birlik Yöneticisi", new String[]{
        "PERM_USER_READ",
        "PERM_BIRLIK_READ", "PERM_BIRLIK_UPDATE", "PERM_BIRLIK_MANAGE",
    ...
    GOZLEMCI("Gözlemci / Denetçi", new String[]{
        ...
        "PERM_TOPLANTI_READ",
        "PERM_RAPOR_AIDAT", "PERM_RAPOR_MALI", "PERM_RAPOR_UYE", "PERM_RAPOR_GENEL",
        "PERM_AUDIT_LOG", "PERM_AUDIT_READ"
    });
